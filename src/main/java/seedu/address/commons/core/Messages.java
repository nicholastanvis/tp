...
public class Messages {
    ...
    public static final String MESSAGE_DUPLICATE_CONTACT = "This contact already exists in the list.";
    public static final String MESSAGE_ADD_CONTACT_SUCCESS = "New contact: %1$s";
