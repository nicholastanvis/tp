...
public class Messages {
    ...
    public static final String MESSAGE_DELETE_CONTACT_SUCCESS = "Deleted Entry: %1$s";
    public static final String MESSAGE_NO_SUCH_CONTACT = "There is no such contact with that name!";
